...
const int SERVO_POS_GREEN   = 70;   // green direction
...
static const uint16_t LOOP_DELAY_MS = 20;

float GREEN_MIN_NORM = 0.40f;
float RED_MAX_NORM   = 0.32f;
float BLUE_MAX_NORM  = 0.32f;
float HUE_MIN_DEG    = 108.0f;
float HUE_MAX_DEG    = 145.0f;
float DOMINANCE_MIN  = 0.080f;
uint16_t CLEAR_MIN   = 120;
